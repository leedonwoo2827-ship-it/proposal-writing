...
> `#` 수 = 레벨. `#`만 제목체(돋움체 Bold), `##`~`######`은 본문.

| 마크다운 | 기호 | 폰트 | 용도 |
|---------|------|------|------|
| `#` | (없음) | 돋움체 Bold 18pt | **제목체** (섹션 구분) |
| `##` | (없음) | 바탕체 Medium 11pt | 일반 본문 |
| `###` | □ | 바탕체 Medium 11pt | 본문 항목 |
| `####` | ○ | 돋움체 Medium 10pt | 세부 항목 |
| `#####` | ― | 돋움체 Medium 11pt | 보충 항목 |
| `######` | ※ | 바탕체 Light 10pt | 참고/주석 |
